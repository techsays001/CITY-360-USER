            ...
            public void onClick(View view) {
                ...
                if(npass.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(Resetpass.this, "Password Noy Match ", Toast.LENGTH_LONG).show();
                                            ...
                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/City_360/resetpassuser.php",
...
//If we are getting success from server
                                                            ...
                                                            if(response.equals("Successful"))
                                                            {
                                                                ...
                                                                new SweetAlertDialog(Resetpass.this, SweetAlertDialog.WARNING_TYPE)
                                                                        .setTitleText("Passwored rese complet")
                                                                                ...
                                                                                sDialog
                                                                                        ...
                                                                                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                                                            ...
                                                                                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                                                                                Intent in=new Intent(Resetpass.this,Signin.class);
                                                                                                startActivity(in);
                                                                                            }
                                                                                        })
